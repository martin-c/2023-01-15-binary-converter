...
basic.forever(function () {
    basic.showString("" + toHexDigit(pins.digitalReadPin(DigitalPin.P13), pins.digitalReadPin(DigitalPin.P14), pins.digitalReadPin(DigitalPin.P15), pins.digitalReadPin(DigitalPin.P16)), 25)
})
